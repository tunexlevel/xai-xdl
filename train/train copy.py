...
for idx in sorted(idx2token):
    print(idx, repr(idx2token[idx]))
...
#     print("RAW PRODUCT :", df.iloc[i]['products'])
#     print("RAW REACTANT:", df.iloc[i]['reactants'])

#     print("SRC IDS     :", src.tolist())
#     print("TGT IDS     :", tgt.tolist())


exit(0)  # Exit after printing the first 5 rows for inspection
# Build vocabulary
token2idx, idx2token = build_vocab(all_smiles)
pad_idx = token2idx[PAD_TOKEN]
