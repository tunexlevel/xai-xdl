...
LEARNING_RATE = 5e-4
PAD_TOKEN = "<pad>"
DATASET_NAME = "uspto_mit_mapped" #/kaggle/input/datasets/tunexlevel/uspto-mit-mapped/uspto_mit_mapped.csv
FILE_NAME = f"{DATASET_NAME}_ed_4-4" 
FILE_PATH = "/content/drive/MyDrive/Colab Notebooks/uspto_mit_mapped.csv" #ROOT / "data" / "raw" / "train-data" /  f"{DATASET_NAME}.csv"
HEADS = 8
